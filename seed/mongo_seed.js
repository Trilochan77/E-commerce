...
db.products.insertMany([
  ...
  P("P-1006", "Tablet Tab A11 64GB", "11in display, quad speakers, 8000mAh", 12999, "C-01", 28, true),
  P("P-1007", "Mechanical Keyboard RGB", "Hot-swap brown switches, PBT caps", 3499, "C-01", 45, true),
  P("P-1008", "Drone SkyCam 4K", "3-axis gimbal, 30-min flight, carry case", 24990, "C-01", 12, true),
  ...
  P("P-2005", "Cotton Kurta Festive", "Breathable cotton, sizes S-XXL", 1199, "C-02", 75, true),
  P("P-2006", "Leather Wallet RFID", "Genuine leather, 8 card slots", 749, "C-02", 140, false),
  P("P-2007", "Sports Backpack 35L", "Water-repellent, laptop sleeve", 1599, "C-02", 65, true),
  ...
  P("P-3005", "Mixer Grinder 750W", "3 jars, overload protection", 3299, "C-03", 40, true),
  P("P-3006", "Ceramic Dinner Set (18pc)", "Chip-resistant glaze, serves 6", 2499, "C-03", 30, true),
  P("P-3007", "Room Heater Oil-Filled", "13-fin, 2900W, thermostat", 8990, "C-03", 18, false),
  ...
  P("P-4004", "Indian Polity Primer", "UPSC-ready reference, latest edition", 650, "C-04", 120, false),
  P("P-4005", "Kids Story Box (6 books)", "Illustrated bedtime collection", 899, "C-04", 95, true),
  P("P-4006", "Cookbook: 100 Curries", "Regional classics with photos", 599, "C-04", 110, false),
  ...
  P("P-5005", "Football Size 5 Pro", "Machine-stitched, all-weather", 1299, "C-05", 70, true),
  P("P-5006", "Skipping Rope Speed", "Ball-bearing handles, adjustable", 349, "C-05", 160, false),
  P("P-5007", "Badminton Set (2+shuttle)", "Aluminium rackets, carry bag", 1499, "C-05", 55, true)
]);
